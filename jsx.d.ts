/**
 * Taken from solid-js and adapted
...
declare namespace JSX {
  ...
  type EventHandlerUnion<T, E extends Event> = EventHandler<T, E>;

  interface DOMAttributes<T> {
    // This typing doesn't get used when not importing react types anywhere?? We tried to have proper types here, but it was too much work (see https://gitlab.com/depict-ai/depict.ai/-/merge_requests/5226)
    children?: any;
    innerHTML?: string;
  ...
  // Our JSX runtime only supports style attributes as strings, leaving this in here in case we want to change it in the future
